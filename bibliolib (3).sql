...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  Dim 23 mai 2021 à 18:46
...
INSERT INTO `abonnements` (`id_clients`, `iban`, `bic`, `statut`, `date_debut`) VALUES
(13, 'FR0000000000000', 'SKRTT', 1, '2021-03-09 22:51:18'),
(5, 'FR00000000000', 'JHGYUG44H', 1, '2021-03-16 09:14:18'),
(4, '0000000', '000', 1, '2021-04-13 15:52:09');
...
INSERT INTO `achats` (`id_livres`, `id_clients`, `en_magasin`, `statut`) VALUES
(10, 13, 0, 1),
(17, 15, 0, 0),
(23, 13, 1, 1),
(39, 13, 0, 1),
...
--
-- Structure de la table `actu_img`
--

DROP TABLE IF EXISTS `actu_img`;
CREATE TABLE IF NOT EXISTS `actu_img` (
...
--
-- Déchargement des données de la table `actu_img`
--

INSERT INTO `actu_img` (`id`, `content`) VALUES
(1, 'img/actu1.png'),
(2, 'img/actu2.png'),
(3, 'img/actu3.png');
...
INSERT INTO `admins` (`id`, `login`, `password`, `A_a`, `att`) VALUES
(1, 'djiby', '$2a$11$IR/xL0ZGE4LyMr2oDL3bUeItghQzPuvgsgbTadrvYO.6mSX9JM48q', 1, NULL),
(2, 'geebee', '$2y$10$CP0geqOGe.iYtch9yNChMuXA90XWZP/q3GF8cHUAMYIdJRCr/sAau', 0, NULL),
(3, 'ADMIN', '$2a$11$e6QAFpGqZYCDh.Sf5Rc8h.mzGepXIwfzeRwjoY8Dnk5dZFXk9C6yC', 1, NULL),
(4, 'jan.s', '$2a$11$9uA25sJ1MTeGfxJcu1kzSeqBqRwa7KNqT3bKIhHjqQ1FeyNKIm7yO', 0, 1),
(5, 'Adminsite', '$2a$11$1CdBdAFOgzmvRb2KGd9K7OxhCE/DB/d3vm93iVketRrRF2DmBcd02', 0, 1);
...
INSERT INTO `adresses` (`id`, `numero`, `rue`, `ville`, `codepostal`, `att`) VALUES
(3, 46, 'rue de Meaux', 'Paris', 75019, 1),
(4, 115, 'Avenue de Wagram', 'Paris', 75017, NULL),
(5, 77, 'Rue des Vignes', 'Paris', 75016, NULL),
(6, 90, 'Rue Léon Gambetta', 'Lille', 59800, NULL),
(7, 352, 'Rue de Vaugirard', 'Paris', 75015, NULL),
(8, 8, 'Rue Pierre Larousse', 'Paris', 75014, 1),
(9, 82, 'Avenue du Général Leclerc', 'Paris', 75014, NULL),
(10, 24, 'Rue du Moulin des Prés', 'Paris', 75013, NULL),
(11, 5, 'Rue Colbert', 'Montigny-le-Bretonneux', 78885, NULL),
(12, 2, 'Avenue des Érables', 'Saint-Maur-des-Fossés', 94100, NULL),
(13, 21, 'Rue des Hallebardes', 'Strasbourg', 67000, NULL),
(14, 9, 'Rue de la Convention', 'Montreuil', 93100, NULL),
(15, 8, 'Rue Jules Joffrin', 'Saint-Denis', 93200, NULL),
(16, 3, 'Rue Guillot', 'Colombes', 92700, NULL),
(17, 28, 'Rue au Pain', 'Saint-Germain-en-Laye', 78100, NULL),
(18, 11, 'Rue de la Paroisse', 'Fontainebleau', 77300, NULL),
(19, 21, 'Rue Professeur Grignard', 'Lyon', 69007, NULL),
(20, 15, 'Rue Beauvau', 'Marseille', 13001, NULL),
(21, 25, 'Rue de la Pomme', 'Toulouse', 31000, NULL),
(22, 8, 'Rue de Saverne', 'Nantes', 44000, NULL),
(23, 18, 'Rue Arnaud Miqueu', 'Bordeaux', 33000, NULL),
(24, 28, 'Rue Maurice Courtan', 'Poissy', 78300, NULL);
...
INSERT INTO `annonces` (`id`, `titre`, `contenu`, `date_time`) VALUES
(1, 'Réouverture Porgressive', 'La réouverture complète de nos établissements est prévue pour le 2 juin. \r\nEn attendant vous pouvez accéder à tous les services de Bibliolib en passant par notre site.\r\nLes libraires et bibliothécaires seront disponible du lundi au vendredi de 9h à 17h pour vous accompagnez et répondre à toutes vos questions \r\n', '2021-04-30 19:53:21'),
(6, 'test12', 'azazazazazazaz', '2021-05-01 15:27:41');
...
CREATE TABLE IF NOT EXISTS `bibliotheques` (
  ...
  `id_adminsite` int(11) NOT NULL,
  PRIMARY KEY (`id_adresse`,`id_adminsite`),
  KEY `bibliotheques_ibfk_1` (`id_adminsite`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `bibliotheques` (`id_adresse`, `id_adminsite`) VALUES
(3, 4),
(8, 5);
...
INSERT INTO `chatbox` (`id`, `id_sender`, `id_recipient`, `content`, `date_time`, `lu`) VALUES
(33, 1, 3, 'azazazaz', '2021-01-21 12:41:09', 0),
(34, 1, 3, 'azazfdfvgfgeerfcdferfdfreredfd', '2021-01-21 12:41:22', 0),
(35, 1, 3, 'hey\r\n', '2021-01-21 12:55:05', 0),
(36, 1, 3, 'eee', '2021-01-21 12:55:08', 0),
(37, 3, 1, 'yoooo\r\n', '2021-01-23 20:15:25', 0),
(38, 1, 3, 'jey', '2021-01-23 22:16:30', 0),
(39, 1, 2, 'yoooo bien ?', '2021-01-23 22:22:32', 1),
(40, 1, 3, 'on est là', '2021-01-23 22:30:46', 0),
(41, 1, 3, 'dfdf', '2021-01-23 22:48:07', 0),
(42, 1, 3, 'yoo', '2021-02-16 11:04:03', 0),
(43, 1, 2, 'hey\r\n', '2021-02-16 11:04:18', 1),
(44, 1, 2, 'bonjour avez vous besoin d\'aide ?', '2021-04-14 06:18:55', 1),
(45, 1, 3, 'erere', '2021-04-14 06:20:26', 0),
(46, 1, 2, '??', '2021-04-14 06:32:54', 1),
(47, 1, 4, 'bonjour avez vous besoin d\'aide ?\r\n', '2021-04-14 06:33:18', 1),
(48, 3, 1, 'oui', '2021-04-14 06:36:30', 0),
(49, 3, 2, 'ADMIN bienvenue', '2021-04-14 06:37:17', 1),
(50, 3, 4, 'BIENVENUE', '2021-04-14 06:37:24', 1),
(51, 1, 2, 're\r\n', '2021-04-14 09:37:15', 1),
(52, 1, 2, 'test \r\n', '2021-04-14 09:37:30', 1),
(53, 1, 2, 'rererdfqdf', '2021-04-14 09:37:33', 1),
(54, 4, 2, 'salut, avez vous reçu la commande ?', '2021-04-14 11:28:38', 1),
(55, 2, 4, 'Bonjour, non pas encore !\r\non attend toujours', '2021-04-14 12:15:42', 1),
(56, 2, 3, 'Merci l\'ADMIN\r\n', '2021-04-14 12:16:39', 0),
(57, 2, 4, 'Bibliolib n\'a pas encore valider', '2021-04-14 12:18:20', 0),
(58, 2, 1, 'oui et vous \r\n', '2021-05-02 13:18:10', 0);
...
INSERT INTO `clients` (`id_clients`, `nom`, `prenom`, `login`, `mdp`, `adresse`) VALUES
(4, 'vich', 'zlatan', 'azerty', '$2y$10$LgytASosxfWE4v0E3d68i.QxVsfsebjvHxW21O97AyABWpJ5jfCCq', '24 rue albert ville 75017'),
(5, 'KEJHA', 'jan', 'jan', '$2y$10$yAr92cy3W9KXUXG90hJRxepX/W9KclaxW9bI0NrY4n77V083./04y', '25 rue azerty 44300'),
(6, 'spleesh', 'dinero', 'Djibyg', '$2y$10$sSxF4UlGISlIY2KGJbzJDergevoMAhcP6RxiBo2mYoAa8.VZSbv7S', '45 rue george sill'),
(7, 'Ganx', 'zerty', 'asx', '$2y$10$Bccn6zHF6eQECgp/6lbIY.tNBYtH729unF4RgLwHxEJtNoboVCbtW', '55 rue gaston berger 65800'),
(13, 'fdfd', 'dfdfd', 'sasuke', '$2y$10$XhAEzKXsV7S61U4/gUgGZecFySaAoefzWcQQGPCAY8uDBq4WSbPOO', '28 rue sos paris 25800'),
(14, 'toto', 'toto', 'toto', '$2y$10$/zE/lJG3ZWepD0QlgCPzgO8pzcRaapayoxHxNVX43W83NTe2D7qBK', '25 rue delabellevie 78560'),
(15, 'gaasss', 'bydji', 'bydji', '$2y$10$IdhwDyWtYqpIBmfsTeIuHe/5WKvLBQPgjR1zXUVN8hNUXVpnP1k6S', '24 rue de barre 7745d5'),
(16, 'Doe', 'John', 'Johndoe', '$2y$10$Q6iby2H3rRRuZcz.xuKcceNqQC4ArxzdHF0oGWqEk1I/XEPyrNHOq', '27 rue de la beaute, paris 79260');
...
--
-- Déchargement des données de la table `commande_livres`
--

INSERT INTO `commande_livres` (`id_commandes`, `titre_livre`) VALUES
(1, 'chatelet'),
(2, 'Naruto');
...
--
-- Structure de la table `customers_questions`
--

DROP TABLE IF EXISTS `customers_questions`;
CREATE TABLE IF NOT EXISTS `customers_questions` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Déchargement des données de la table `customers_questions`
--

INSERT INTO `customers_questions` (`id`, `prenom`, `nom`, `email`, `sujet`, `contenu`, `date_time`) VALUES
(3, 'Djibril', 'GASSAMA', 'gassamadjibril@outlook.com', 'avis sur le site', 'Bonjour, c\'était pour vous dire que votre site est oufffff', '2020-12-13 17:40:49'),
(4, 'test', 'test', 'test@test.com', 'test', 'test', '2020-12-13 17:47:25'),
(6, 'prenom', 'kre', 'zkejr@eore.com', 'kkekr', 'erererererere', '2021-04-11 23:20:57');
...
INSERT INTO `emprunter` (`id_clients`, `id_livres`, `en_magasin`, `statut`) VALUES
(5, 8, 0, 1),
(5, 9, 0, 1),
(5, 14, 1, 1),
(5, 15, 0, 1),
...
CREATE TABLE IF NOT EXISTS `librairies` (
  ...
  `id_adminsite` int(11) NOT NULL,
  PRIMARY KEY (`id_adresse`,`id_adminsite`),
  KEY `librairies_ibfk_1` (`id_adminsite`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `librairies` (`id_adresse`, `id_adminsite`) VALUES
(3, 4);
...
CREATE TABLE IF NOT EXISTS `pertes` (
  ...
  PRIMARY KEY (`id_livres`,`id_clients`),
  KEY `id_clients` (`id_clients`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `pertes` (`id_livres`, `id_clients`, `causes`) VALUES
(10, 13, 'aaaaaaaa');
...
--
-- Déchargement des données de la table `users_questions`
--

INSERT INTO `users_questions` (`id_clients`, `email`, `contenu`, `date_time`, `statut`, `reponse`, `lu`) VALUES
(4, 'aaaaa@aaaaaa.aa', 'gegegegeggeeg egeg egeege ege ege gee ege ege geege ecc ?', '2021-04-13 15:52:46', 1, 'gfhgfhgfgfhgfhgfhgfgfhgfhg', 1),
(5, 'zezez@ezeze.ezez', 'ezezez', '2021-04-13 14:19:34', 1, 'ererefdferedf', 0),
(13, 'efefeef@efeef.fe', 'fefefefef efe ', '2021-04-13 13:46:19', 1, 'aaaa', 1),
(4, 'aaaaa@aaaaaa.a', 'gfggvfhtr', '2021-04-13 16:13:57', 1, 'azesdqfdfsdf', 1),
(4, 'aaaaa@aaaaaa.a', 'httrtyhfng', '2021-04-13 16:14:25', 1, 'sfsdfsdfsdsd', 1),
(4, 'sasuke123@gemila.commo', 'anced relation much sportsmen see formed wrong happiness. Mistaken can vexed play objection children ﻿no. Direction betrayed message marry exposed beloved surrounded up mistaken like trifling cannot party smile. Uneasy continual dull add stanhill unaffected offended fond blush sir remember. Really commanded man tastes upon neat except partiality supplied surprise matter gate begin hoped examine. ', '2021-04-13 17:48:34', 0, ' ', 0),
(13, 'diiiii@aoej.fr', 'salut c\'est comment ? ', '2021-04-14 08:11:48', 0, ' ', 0);

-- --------------------------------------------------------

--
-- Structure de la table `ventes_en_magasin`
--

DROP TABLE IF EXISTS `ventes_en_magasin`;
CREATE TABLE IF NOT EXISTS `ventes_en_magasin` (
...
--
-- Déchargement des données de la table `ventes_en_magasin`
--

INSERT INTO `ventes_en_magasin` (`id_vente`, `id_livres`, `nom_prenom`, `email`, `date_time`) VALUES
(1, 7, 'DJIS', 'gassamadjibril@zekzez.zepzk', '2021-04-12 17:24:11'),
(2, 7, 'ererer', 'test.ee@oerer.te', '2021-04-12 17:25:02'),
(3, 7, 'djibril', 'gassamadjibril@outlook.com', '2021-04-12 17:37:56'),
(4, 46, 'fjiby', 'gassamadjibril221@gmail.com', '2021-04-12 23:39:45'),
(5, 81, 'djibiii', 'hddc@hfd.fr', '2021-04-12 23:45:22'),
(6, 7, 'Djiby', 'gassamadjibril@utlook.com', '2021-04-12 23:54:19');
...
ALTER TABLE `abonnements`
  ADD CONSTRAINT `abonnements_ibfk_1` FOREIGN KEY (`id_clients`) REFERENCES `clients` (`id_clients`);

--
-- Contraintes pour la table `achats`
--
ALTER TABLE `achats`
  ADD CONSTRAINT `achats_ibfk_1` FOREIGN KEY (`id_livres`) REFERENCES `livres` (`id_livres`),
  ADD CONSTRAINT `achats_ibfk_2` FOREIGN KEY (`id_clients`) REFERENCES `clients` (`id_clients`);

--
-- Contraintes pour la table `bibliotheques`
--
ALTER TABLE `bibliotheques`
  ADD CONSTRAINT `bibliotheques_ibfk_1` FOREIGN KEY (`id_adminsite`) REFERENCES `admins` (`id`),
  ADD CONSTRAINT `bibliotheques_ibfk_2` FOREIGN KEY (`id_adresse`) REFERENCES `adresses` (`id`);

--
-- Contraintes pour la table `chatbox`
--
ALTER TABLE `chatbox`
  ADD CONSTRAINT `chatbox_ibfk_1` FOREIGN KEY (`id_recipient`) REFERENCES `admins` (`id`),
  ADD CONSTRAINT `chatbox_ibfk_2` FOREIGN KEY (`id_sender`) REFERENCES `admins` (`id`);
...
ALTER TABLE `librairies`
  ADD CONSTRAINT `librairies_ibfk_1` FOREIGN KEY (`id_adminsite`) REFERENCES `admins` (`id`),
  ADD CONSTRAINT `librairies_ibfk_2` FOREIGN KEY (`id_adresse`) REFERENCES `adresses` (`id`);
...
--
ALTER TABLE `pertes`
  ADD CONSTRAINT `pertes_ibfk_1` FOREIGN KEY (`id_clients`) REFERENCES `clients` (`id_clients`),
  ADD CONSTRAINT `pertes_ibfk_2` FOREIGN KEY (`id_livres`) REFERENCES `livres` (`id_livres`);

--
-- Contraintes pour la table `users_questions`
--
ALTER TABLE `users_questions`
  ADD CONSTRAINT `users_questions_ibfk_1` FOREIGN KEY (`id_clients`) REFERENCES `clients` (`id_clients`);

--
-- Contraintes pour la table `ventes_en_magasin`
--
ALTER TABLE `ventes_en_magasin`
  ADD CONSTRAINT `ventes_en_magasin_ibfk_1` FOREIGN KEY (`id_livres`) REFERENCES `livres` (`id_livres`);
COMMIT;
